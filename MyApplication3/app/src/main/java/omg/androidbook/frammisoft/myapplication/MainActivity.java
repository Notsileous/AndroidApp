...
//variable to hold searched item
...
// and then set its text
        ...
        mainTextView.setText(R.string.textview);
...
//set the searched item value to a variable to be passed to detail class
        BookChoice= mainEditText.getText().toString();
